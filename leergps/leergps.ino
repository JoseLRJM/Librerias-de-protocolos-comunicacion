...
void leerbeacon1(){
  ...
  for (unsigned long start = millis(); millis() - start < 130;){
...
void leerbeacon2(){
  ...
  if (newData){
    beacon2.get_position(&lat2, &lon2, &age2);
    Serial.print("LAT=");
    Serial.print(lat2);
    //Serial.print(" LON=");
    //Serial.println(lon1);
...
void mav_gps(){
 ...
 int32_t lat=lat1; /*< [degE7] Latitude (WGS84)*/
 int32_t lon=lon1; /*< [degE7] Longitude (WGS84)*/
